...
interface UserExtensionPoint extends ExtensionPoint
{
	...
	/**
	 * Returns the link to the page on which user messages for the current module will be displayed
	...
	/**
	 * Returns the link name of the page on which user messages that will be displayed
	 * @return the link name
	 */
	function get_publications_module_name();

	/**
	 * Returns the folder name of the module
	 * @return the folder name
	 */
	function get_publications_module_id();

	/**
	 * Returns the picture associated with the link of the page on which user messages will be displayed
