...
class ClassLoader
{
    ...
    /**
     * Generates the autoload cache file by exploring PHPBoost folders and modules.
     *
    ...
    /**
     * Adds classes from all installed modules to the autoload list.
     *
    ...
    /**
     * Clears the autoload cache and regenerates it.
     * This is called by ModulesManager when modules are installed/uninstalled.
     */
    public static function update_class_list(): void
    {
        self::clear_cache();
        self::generate_classlist(true);
    }
