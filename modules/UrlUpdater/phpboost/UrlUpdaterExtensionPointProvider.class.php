...
class UrlUpdaterExtensionPointProvider extends ExtensionPointProvider
{
    ...
    public function url_mappings()
    {
        ...
        {
            $this->urls_mappings[] = new UrlMapping('^poll/poll\.php$', '/modules/poll/', 'L,R=301');
        }
        ...
        if (ModulesManager::is_module_installed('stats') && ModulesManager::is_module_activated('stats') && $actual_major_version >= '6.0')
        {
            ...
            $this->urls_mappings[] = new UrlMapping('^stats/stats\.php$', '/modules/stats/', 'L,R=301');
        }
        ...
        {
            $this->urls_mappings[] = new UrlMapping('^wiki/wiki\.php$', '/modules/wiki/', 'L,R=301');
