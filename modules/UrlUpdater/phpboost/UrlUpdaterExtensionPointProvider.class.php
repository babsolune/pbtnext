 ...
 * @version     PHPBoost 6.1 - last update: 2026 03 15
...
class UrlUpdaterExtensionPointProvider extends ExtensionPointProvider
{
    ...
    public function url_mappings()
    {
        ...
        {
            $this->urls_mappings[] = new HighPriorityUrlMapping('^poll/poll\.php$', '/modules/poll/', 'L,R=301');
        }
        ...
        if (ModulesManager::is_module_installed('stats') && ModulesManager::is_module_activated('stats') && $actual_major_version >= '6.0')
        {
            ...
            $this->urls_mappings[] = new HighPriorityUrlMapping('^stats/stats\.php$', '/modules/stats/', 'L,R=301');
        }
        ...
        {
            $this->urls_mappings[] = new HighPriorityUrlMapping('^wiki/wiki\.php$', '/modules/wiki/', 'L,R=301');
