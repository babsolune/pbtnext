...
class AdminContactConfigController extends DefaultAdminModuleController
{
	public function execute(HTTPRequestCustom $request)
	{
		...
		return new AdminContactDisplayResponse($this->view, StringVars::replace_vars($this->lang['form.module.title'], ['module_name' => self::get_module()->get_configuration()->get_name()]));
	}
	...
	private function build_form()
	{
		...
		if ($this->config->is_googlemaps_available())
		{
			$map_fieldset = new FormFieldsetHTML('map', $this->lang['contact.map.location'], ['disabled' => !$this->config->is_googlemaps_available()]);
