...
class DownloadPendingItemsController extends DefaultModuleController
{
	...
	public function build_view(HTTPRequestCustom $request)
	{
		...
		if (in_array($field, [DownloadItem::SORT_FIELDS_URL_VALUES[DownloadItem::SORT_ALPHABETIC], DownloadItem::SORT_FIELDS_URL_VALUES[DownloadItem::SORT_AUTHOR], DownloadItem::SORT_FIELDS_URL_VALUES[DownloadItem::SORT_DATE]]))
	...
	private function build_sorting_form($field, $mode)
	{
		...
		$fieldset->add_field(new FormFieldSimpleSelectChoice('sort_fields', '', $field,
			...
			['events' => ['change' => 'document.location = "'. DownloadUrlBuilder::display_pending()->rel() . '" + HTMLForms.getField("sort_fields").getValue() + "/" + HTMLForms.getField("sort_mode").getValue();']]
		));
