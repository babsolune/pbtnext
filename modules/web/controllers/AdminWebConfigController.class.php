...
class AdminWebConfigController extends DefaultAdminModuleController
{
	...
	private function build_form()
	{
		...
		$fieldset->add_field(new FormFieldSimpleSelectChoice('display_type', $this->lang['form.display.type'], $this->config->get_display_type(),
			[
				new FormFieldSelectChoiceOption($this->lang['form.display.type.grid'], WebConfig::GRID_VIEW, ['data_option_icon' => 'far fa-id-card']),
				new FormFieldSelectChoiceOption($this->lang['form.display.type.list'], WebConfig::LIST_VIEW, ['data_option_icon' => 'fa fa-list']),
				new FormFieldSelectChoiceOption($this->lang['form.display.type.table'], WebConfig::TABLE_VIEW, ['data_option_icon' => 'fa fa-table'])
			],
			[
				'select_to_list' => true,
				'events' => ['change' => '
		...
		$fieldset->add_field(new FormFieldSimpleSelectChoice('partners_sort', $this->lang['web.config.partners.sort'], $this->config->get_partners_sort_field() . '-' . $this->config->get_partners_sort_mode(), $this->get_sort_options(),
			['description' => $this->lang['web.config.partners.sort.clue']]
		));
