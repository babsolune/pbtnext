...
class SandboxBuilderController extends DefaultModuleController
{
	...
	{
		return new FileTemplate('sandbox/SandboxBuilderController.tpl');
	}
	...
	private function build_form()
	{
		...
		$choices = new FormFieldsetHTML('choices', $this->lang['sandbox.builder.checked.choices']);
			...
			$choices->add_field(new FormFieldRadioChoice('inline_radio', $this->lang['sandbox.builder.radio'] . ' inline', '',
				...
				['required' => true, 'class' => 'css-class inline-radio']
			));
			$default_option = new FormFieldRadioChoiceOption($this->lang['sandbox.builder.choice'].'1', '1');
		...
		$select = new FormFieldsetHTML('selects', $this->lang['sandbox.builder.selects']);
			...
			$select->add_field(new FormFieldSimpleSelectChoice('fake_select', $this->lang['sandbox.builder.select.to.list'],
				...
				[
					new FormFieldSelectChoiceOption('&nbsp;', '0'),
					new FormFieldSelectChoiceOption($this->lang['sandbox.builder.choice'].'1', '1', ['data_option_class' => 'bgc-full question', 'selected' => true, 'data_option_icon' => 'far fa-id-card']),
				...
				['class' => 'css-class', 'select_to_list' => true]
			));
		...
		$horizontal_fieldset = new FormFieldsetHorizontal('horizontal_fieldset');
			...
			$horizontal_fieldset->add_field(new FormFieldCheckbox('cbvert2', $this->lang['sandbox.builder.checkbox'], FormFieldCheckbox::CHECKED, ['class' => 'css-class']));
		...
		// CAPTCHA
			...
			$captcha->add_field(new FormFieldSpacer('captcha', $this->lang['sandbox.builder.captcha']));
