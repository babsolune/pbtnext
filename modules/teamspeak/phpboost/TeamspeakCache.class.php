 ...
 * @version     PHPBoost 6.1 - last update: 2021 05 29
...
class TeamspeakCache implements CacheData
{
	...
	public function synchronize()
	{
		...
		$this->view = new FileTemplate('modules/teamspeak/TeamspeakAjaxViewerController.tpl');

		/* load framework library */
		require_once(PATH_TO_ROOT . '/modules/teamspeak/lib/teamspeak3/teamspeak3.php');
		...
		try
		{
			...
			$viewer_pictures = new Url(PATH_TO_ROOT . '/modules/teamspeak/templates/images/viewer/'); /* Specific Flags used by teamspeak */
	...
	{
		return CacheManager::load(self::class, 'teamspeak', 'viewer');
	}
