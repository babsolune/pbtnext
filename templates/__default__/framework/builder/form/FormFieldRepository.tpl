    ...
    # START fieldelements #
        <li id="${escape(ID)}_{fieldelements.ID}">
            <div class="grouped-inputs flex-wide">
                ...
                <a class="delete-item grouped-element bgc-full error# IF NOT C_DELETE # icon-disabled# ENDIF #" href="javascript:FormFieldRepository.delete_field({fieldelements.ID});" id="delete_${escape(ID)}_{fieldelements.ID}" aria-label="{@common.delete}"# IF C_DELETE # data-confirmation="delete-element"# ENDIF #><i class="far fa-trash-alt" aria-hidden="true"></i></a>
