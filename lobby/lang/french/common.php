...
$lang['lobby.add.modules.warning']     = '
    ...
    <p>Cliquer sur <strong>Valider</strong> pour ajouter les nouveaux modules au <strong>Lobby</strong>.</p>
';
...
$lang['lobby.new.modules.description'] = '
    <p>Des nouveaux modules compatibles avec le <strong>Lobby</strong> ont été installés et activés sur le site :</p>
    <p class="text-strong">:modules_list</p>
';
...
$lang['lobby.hide.menu.left']           = 'Cacher le menu gauche';
$lang['lobby.hide.menu.right']          = 'Cacher le menu droite';
$lang['lobby.hide.menu.top.central']    = 'Cacher le menu central haut';
$lang['lobby.hide.menu.bottom.central'] = 'Cacher le menu central bas';
$lang['lobby.hide.menu.top.footer']     = 'Cacher le menu sur-pied de page';
...
// Pinned news
$lang['lobby.pinned.news.title'] = 'Titre sur la page d\'accueil';
// Default
$lang['lobby.edito.description'] = 'Accédez à la <a class="offload" href="' . LobbyUrlBuilder::configuration()->relative() . '">configuration du module</a> pour paramétrer la page d\'accueil';
