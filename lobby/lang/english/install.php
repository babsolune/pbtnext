...
$lang['lobby.edito.description'] = '
    ...
    <div class="cell-flex formatter-columns cell-columns-4 cell-tile">
        ...
        <div class="cell">
            ...
            <div class="cell-body">
                <div class="cell-content">
                    ...
                    <a class="offload" href="' . AdminModulesUrlBuilder::add_module()->relative() . '">Add modules</a> then give them access rights.
                </div>
            </div>
        </div>
        <div class="cell">
        ...
        <div class="cell">
            <div class="cell-header"><h4 class="formatter-title">7. Content</h4></div>
            <div class="cell-body">
                <div class="cell-content">
