...
class AdminGeneralConfigController extends DefaultAdminController
{
    ...
    private function build_form()
    {
        ...
        $fieldset->add_field(new FormFieldThemesSelect('default_theme', $this->lang['configuration.default.theme'], $this->user_accounts_config->get_default_theme(),
            [
                ...
                'events' => ['change' => 
                    $this->construct_javascript_picture_theme() . '
    ...
    private function save()
    {
        ...
        HooksService::execute_hook_action('edit_config', 'kernel', ['title' => $this->lang['configuration.general'], 'url' => AdminConfigUrlBuilder::general_config()->rel()]);
    }
    ...
    {
        $options = [new FormFieldSelectChoiceOption($this->lang['configuration.other.start.page'], 'other')];
