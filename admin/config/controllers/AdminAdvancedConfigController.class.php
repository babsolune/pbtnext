 ...
 * @version     PHPBoost 6.1 - last update: 2022 12 11
...
class AdminAdvancedConfigController extends DefaultAdminController
{
    ...
    private function build_form(HTTPRequestCustom $request)
    {
        ...
        {
            $subdomain_redirection_desc =  new SpanHTMLElement($this->lang['configuration.redirection.subdomain'], [], 'error');
            $local_redirection_desc = new SpanHTMLElement($this->lang['configuration.redirection.local'], [], 'error');
        ...
        {
            $https_redirection_desc = new SpanHTMLElement($this->lang['configuration.redirection.https.disabled'], [], 'error');
        ...
        try {
            ...
            {
                $url_rewriting_desc = new SpanHTMLElement($this->lang['configuration.available'], [], 'success');
            ...
            {
                $url_rewriting_desc = new SpanHTMLElement($this->lang['configuration.not.available'], [], 'error');
            ...
            $url_rewriting_desc = new SpanHTMLElement($this->lang['configuration.unknown'], [], 'notice');
            $url_rewriting_fieldset->add_field(new FormFieldCheckbox('url_rewriting_enabled', $this->lang['configuration.url.rewriting'], $this->server_environment_config->is_url_rewriting_enabled(),
                [
                    'class' => 'half-field custom-checkbox',
                    'description' => $url_rewriting_desc->display()
        ...
        $sessions_config_fieldset->add_field(new FormFieldTextEditor('cookie_name', $this->lang['configuration.cookie.name'], $this->sessions_config->get_cookie_name(),
            ...
            [new FormFieldConstraintRegex('`^[A-Za-z0-9]+$`iu', '', $this->lang['warning.regex.letters.numbers'])]
        ));
        ...
        $cookiebar_config_fieldset->add_field(new FormFieldNumberEditor('cookiebar_duration', $this->lang['configuration.cookiebar.duration'], $this->cookiebar_config->get_cookiebar_duration(),
            ...
            [new FormFieldConstraintRegex('`^[0-9]+$`iu'), new FormFieldConstraintIntegerRange(1, 13)]
        ));
        ...
        {
            $page_compression_desc = new SpanHTMLElement($this->lang['configuration.available'], [], 'success');
        ...
        {
            $page_compression_desc = new SpanHTMLElement($this->lang['configuration.not.available'], [], 'error');
    ...
    private function save()
    {
        ...
        HooksService::execute_hook_action('edit_config', 'kernel', ['title' => $this->lang['configuration.advanced'], 'url' => AdminConfigUrlBuilder::advanced_config()->rel()]);
    }
