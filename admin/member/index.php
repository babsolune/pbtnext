...
$url_controller_mappers = [
	...
	new UrlControllerMapper('AdminExtendedFieldMemberEditController', '`^/extended-fields/([0-9]+)/edit/?$`', ['id']),
	...
	new UrlControllerMapper('AdminMemberDeleteController', '`^/([0-9]+)/delete/?$`', ['id']),
