	...
	private function build_view()
	{
		...
		foreach($installed_themes as $theme)
		{
			...
			$this->view->assign_block_vars('themes_installed', [
				...
				'AUTHORIZATIONS' => Authorizations::generate_select(Theme::ACCES_THEME, $authorizations, [ 2 => true], $theme->get_id()),
			...
			if (count($pictures) > 0)
			{
				...
				foreach ($pictures as $picture)
				{
					...
					$this->view->assign_block_vars('themes_installed.pictures', [
