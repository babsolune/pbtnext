...
class AdminThemeAjaxGithubListController extends AbstractController
{
	public function execute(HTTPRequestCustom $request)
	{
		...
		foreach ($dirs as $item)
		{
			...
			$addons[] = [
				...
				'author'        => isset($config['author_name'])    ? $config['author_name']   : (isset($config['author']) ? $config['author'] : ''),
