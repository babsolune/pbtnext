 ...
 * @version     PHPBoost 6.1 - last update: 2024 03 12
...
class AdminModuleAddController extends DefaultAdminController
{
    ...
    private function build_view()
    {
        ...
        foreach ($grouped_modules as $genre => $modules)
        {
            ...
            foreach ($modules as $id => $module)
            {
                ...
                $this->view->assign_block_vars('genres.server_modules', array(
    ...
    private function get_modules_not_installed()
    {
        ...
        {
            $folder_name = $folder->get_name();
            // Skip if already found in modules folder or if it's the modules folder itself
        ...
        usort($modules_not_installed, array(self::class, 'callback_sort_modules_by_name'));
