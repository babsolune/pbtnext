...
class AdminModuleAjaxWebsiteListController extends AbstractController
{
	public function execute(HTTPRequestCustom $request)
	{
		...
		list($base_url, $index) = AddonRemoteHelper::fetch_server_index($server_url, $server_dir, $phpboost_version, 'modules');
		...
		foreach ($index as $item)
		{
			...
			if (empty($addon_id) || (isset($item['addon_type']) ? $item['addon_type'] : '') !== 'module')
				continue;
