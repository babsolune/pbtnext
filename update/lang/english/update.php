...
//Introduction
    'step.introduction.title'   => 'Update of PHPBoost ' . GeneralConfig::load()->get_phpboost_major_version() . ' to PHPBoost ' . UpdateServices::NEW_KERNEL_VERSION . ' ' . Environment::get_phpboost_name_version(),
    'step.introduction.message' => 'Welcome to update wizard',
    'step.introduction.clue' => '<p>Thank you to have trusted PHPBoost to build your website.</p>
...
//Configuration du serveur
    ...
    'php.version.check.clue' => '<span style="font-weight: bold;color: red;">Required:</span> To run PHPBoost, your server must run PHP :min_php_version or higher. Below that, you might have issues with some modules.',
    ...
    'php.extensions.check.gdLibrary.clue'        => 'Library used to generate pictures such as Robot Protection, Statistics Graphics and much more.',
    'php.extensions.check.curlLibrary'           => 'Curl library',
    'php.extensions.check.curlLibrary.clue'      => 'Library used to get distant elements. Mandatory to enable external authentication for instance.',
    'php.extensions.check.mbstringLibrary'       => 'MBstring library',
    'php.extensions.check.mbstringLibrary.clue'  => 'Library used for UTF-8 characters management. Mandatory to have a working website.',
    ...
    'server.urlRewriting.clue' => 'Not only does it rewrite URLs, but it helps a lot with search engine robots.',
...
//Execute update
    ...
    'step.execute.clue' => 'This step will convert your site PHPBoost ' . GeneralConfig::load()->get_phpboost_major_version() . ' to ' . UpdateServices::NEW_KERNEL_VERSION . ' PHPBoost.
    <br /><br />
