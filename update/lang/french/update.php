...
//Configuration du serveur
    ...
    'php.extensions.check.gdLibrary.clue'        => 'Librairie utilisée pour générer des images. Utile par exemple pour la protection anti robots ou les diagrammes des statistiques du site. Certains modules peuvent également s\'en servir.',
    'php.extensions.check.curlLibrary'           => 'Librairie Curl',
    'php.extensions.check.curlLibrary.clue'      => 'Librairie utilisée pour récupération d\'éléments distants. Nécessaire pour faire fonctionner l\'authentification externe par exemple.',
    'php.extensions.check.mbstringLibrary'       => 'Librairie MBstring',
    'php.extensions.check.mbstringLibrary.clue'  => 'Librairie utilisée pour la gestion des caractères UTF-8. Obligatoire pour avoir un site fonctionnel.',
