 ...
 * @version     PHPBoost 6.1 - last update: 2018 10 09
...
class CLIInstallCommand implements CLICommand
{
    ...
    private string $db_schema        = 'phpboost';
    private string $db_tables_prefix = 'phpboost_';

    private string $website_server      = 'http://localhost';
    private string $website_path        = '/';
    private string $website_name        = 'PHPBoost';
    private string $website_slogan      = '';
    private string $website_description = 'PHPBoost command line installation';
    private string $website_locale      = 'english';
    private string $website_timezone    = 'Europe/Paris';

    private string $user_login    = 'admin';
    private string $user_password = 'admin';
    private string $user_email    = 'admin@mail.com';

    private InstallationServices $installation;
